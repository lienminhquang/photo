...
abstract class AppLocalizations {
  ...
  /// No description provided for @whatIsNewToday.
  ///
  /// In en, this message translates to:
  /// **'WHAT\'S NEW TODAY'**
  String get whatIsNewToday;
  ...
  ///
  /// In en, this message translates to:
  /// **'Please eneter username'**
  String get pleaseEnterUsername;

  /// No description provided for @passwordIsNotMatch.
  ///
  /// In en, this message translates to:
  /// **'Password is not match'**
  String get passwordIsNotMatch;

  /// No description provided for @registerSuccessed.
  ///
  /// In en, this message translates to:
  /// **'Register successed'**
  String get registerSuccessed;

  /// No description provided for @termOfServicesAndPrivacyPolicy.
  ///
  /// In en, this message translates to:
  /// **'By signing up, you agree to Photo’s Terms of Service and Privacy Policy.'**
  String get termOfServicesAndPrivacyPolicy;

  /// No description provided for @termOfServices.
  ///
  /// In en, this message translates to:
  /// **'Terms of Service'**
